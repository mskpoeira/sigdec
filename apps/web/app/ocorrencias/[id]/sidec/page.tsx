...
export default function SidecExportsPage(){
 ...
 return <main className="shell moduleShell">
  <header className="listHeader">
   <div><span className="eyebrow">INTEROPERABILIDADE · SIDEC/SP · v1.20</span><h1>Pacotes da ocorrência</h1><p>Checklist por COBRADE, manifesto íntegro, ZIP documental, mapeamento e revisões para lançamento controlado no sistema estadual.</p></div>
