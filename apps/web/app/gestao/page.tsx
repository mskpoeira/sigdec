...
export default function GestaoPage(){
 ...
 return <main className="shell"><header className="listHeader"><div><span className="eyebrow">SIGDEC · Gestão integrada</span><h1>Planejamento, risco e recuperação</h1><p>Riscos, alertas, S2iD, treinamento, recuperação, integrações e inteligência assistiva.</p></div><Link className="secondaryLink" href="/painel">Voltar</Link></header>
