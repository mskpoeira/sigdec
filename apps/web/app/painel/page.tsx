...
export default function PainelPage(){
 ...
 return <main className="opsDashboard">
  ...
  <section className="opsMain">
   ...
   <footer className="opsFooter"><span>SIGDEC v1.7.0 · Prefeitura da Cidade de Ubatuba - SP | Defesa Civil</span><b>Prevenir é preservar vidas.</b><span>Ubatuba mais segura, hoje e sempre.</span></footer>
  </section>
 </main>
}