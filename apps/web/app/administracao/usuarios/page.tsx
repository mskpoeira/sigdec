...
const paths=["/painel","/ocorrencias","/ocorrencias/nova","/campo","/monitoramento","/assistencia","/voluntarios","/vistorias","/comunicacoes","/sco","/documentos","/planejamento","/planejamento/operacao","/resiliencia","/apoios","/capacitacao","/ajuda-mutua","/operacoes-sazonais","/simulados","/gestao","/continuidade","/administracao","/administracao/cadastros","/administracao/apresentacao","/administracao/auditoria","/administracao/saude"];
