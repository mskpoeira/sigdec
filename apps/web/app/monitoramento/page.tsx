...
return <main className="shell"><header className="listHeader"><div><span className="eyebrow">SIGDEC · v0.5</span><h1>Monitoramento</h1><p>Pluviômetros, estações e pontos monitorados.</p></div><div className="headerActions"><Link className="secondaryLink" href="/painel">Painel</Link></div></header>
