...
const navigationPaths=["/painel","/ocorrencias","/ocorrencias/nova","/campo","/monitoramento","/assistencia",
 "/voluntarios","/vistorias","/comunicacoes","/sco","/documentos","/planejamento","/planejamento/operacao","/gestao","/continuidade","/administracao","/administracao/auditoria","/administracao/saude"] as const;
